...
public class CustomerTest {
    ...
    public void testAddRental() {
        ...
        Movie movie1 = new Movie("Gone with the Wind", Category.REGULAR);
    ...
    public void statementForNewReleaseMovie() {
        Movie movie1 = new Movie("Star Wars", Category.NEW_RELEASE);
        Rental rental1 = new Rental(movie1, 3); // 3 day rental
        Customer customer2 =
                new CustomerBuilder()
                        .withName("Sallie")
    ...
    public void statementForChildrensMovie() {
        Movie movie1 = new Movie("Madagascar", Category.CHILDRENS);
        Rental rental1 = new Rental(movie1, 3); // 3 day rental
        Customer customer2
                = new CustomerBuilder()
                .withName("Sallie")
    ...
    public void statementForManyMovies() {
        ...
        Movie movie2 = new Movie("Star Wars", Category.NEW_RELEASE);
        Rental rental2 = new Rental(movie2, 2); // 2 day rental
        Movie movie3 = new Movie("Gone with the Wind", Category.REGULAR);
